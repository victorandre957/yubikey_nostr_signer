...
async fn main() -> Result<()> {
    ...
    match &uri {
        NostrConnectURI::Bunker { remote_signer_public_key, relays, secret } => {
            println!("   Pubkey do bunker: {}", remote_signer_public_key.to_bech32()?);
    ...
    println!("✅ Chave pública recebida: {}\n", bunker_pubkey.to_bech32()?);
